...
export const CORE_CATEGORY_LABEL_KEYS = {
  ...
  assistive: "PF2E_ITEM_FORGE.Categories.Assistive",
  ...
  "magic.grimoire": "PF2E_ITEM_FORGE.Categories.MagicGrimoire",
  "magic.apex": "PF2E_ITEM_FORGE.Categories.MagicApex",
  "magic.worn": "PF2E_ITEM_FORGE.Categories.MagicWorn",
  "magic.accessory-rune": "PF2E_ITEM_FORGE.Categories.MagicAccessoryRune",
  "magic.held": "PF2E_ITEM_FORGE.Categories.MagicHeld",
  "magic.held.one-hand": "PF2E_ITEM_FORGE.Categories.MagicHeldOneHand",
  "magic.held.two-hands": "PF2E_ITEM_FORGE.Categories.MagicHeldTwoHands",
...
export function registerCoreCategories(registry) {
  const categories = [
    ...
    ["magic.grimoire", "magic", 58.25],
    ["magic.apex", "magic", 58.3],
    ["magic.accessory-rune", "magic", 58.5],
    ["magic.held", "magic", 58.6],
    ["magic.held.one-hand", "magic.held", 58.61],
    ["magic.held.two-hands", "magic.held", 58.62],
    ["magic.worn", "magic", 59],
